...
<p align="center">
  <a href="https://github.com/rajin-khan/Glossa/releases/download/v0.1.4/Glossa-0.1.4-macOS.dmg">
    <img src="https://img.shields.io/badge/Download_for_macOS-0.1.4_preview-78EAF2?style=for-the-badge&logo=apple&logoColor=111111" alt="Download Glossa 0.1.4 preview for macOS">
  </a>
</p>
...
1. [Download Glossa 0.1.4 for macOS](https://github.com/rajin-khan/Glossa/releases/download/v0.1.4/Glossa-0.1.4-macOS.dmg).
...
The preview uses a stable ad-hoc signature so development and testing remain free. It is not notarized with a paid Apple Developer ID yet. You can verify the DMG or zip against [`SHA256SUMS.txt`](https://github.com/rajin-khan/Glossa/releases/download/v0.1.4/SHA256SUMS.txt).
...
This creates `dist/Glossa-0.1.4-macOS.dmg`, `dist/Glossa-0.1.4-macOS.zip`, and `dist/SHA256SUMS.txt` from an optimized build. Set `CODESIGN_IDENTITY` later to package with a paid Developer ID, hardened runtime, and notarization.
